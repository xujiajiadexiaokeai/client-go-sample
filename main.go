...
func main() {
	...
	if *imageName == "" {
		fmt.Println("You must spcify the new image name.")
		os.Exit(0)
	}
	...
	deployment, err := clientset.AppsV1beta1().Deployments("default").Get(context.TODO(), *deploymentName, metav1.GetOptions{})
	if err != nil {
		panic(err.Error())
	}
	if errors.IsNotFound(err) {
		...
		_, err := clientset.AppsV1beta1().Deployments("default").Update(context.TODO(), deployment, metav1.UpdateOptions{})
		if err != nil {
			panic(err.Error())
		}
	}
